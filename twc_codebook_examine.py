...
def load_model(params):
   ...
   # model = my.load_vqgan(configvqf4noattn, ckpt_path="vgg_model/vgg16-397923af.pth", is_gumbel=False).to(DEVICE)
...
def output_image_codes(params):
    input_file = params.input
    recons_output_file =  "codebook_recons_" + input_file.split("/")[-1]
